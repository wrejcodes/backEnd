...
module.exports = (sequelize, DataTypes) => {
  var experiment = sequelize.define('experiment', {
    ...
    cell_short_name: DataTypes.FLOAT,
    cell_growth_mode: DataTypes.STRING,
    assay_footprint: DataTypes.FLOAT,
    ...
    dilution_solvent_percent_max: DataTypes.INTEGER,
    assay_component_name: DataTypes.STRING,
    assay_component_desc: DataTypes.FLOAT,
    assay_component_target_desc: DataTypes.FLOAT,
    ...
    assay_component_endpoint_desc: DataTypes.STRING,
    assay_function_type: DataTypes.STRING,
    normalized_data_type: DataTypes.FLOAT,
    ...
    reagent_arid: DataTypes.FLOAT,
    reagent_reagent_name_value: DataTypes.FLOAT,
    reagent_reagent_name_value_type: DataTypes.STRING,
